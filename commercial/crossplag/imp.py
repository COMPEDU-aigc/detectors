...
class Imp(BaseRequest):
    ...
    def __init__(self, ): 
        ...
        url = "https://lkv1fgxnwa.execute-api.eu-central-1.amazonaws.com/production/detect"
        ...
        '''
{
  ...
  "flags": {
    "sessExT": "2023-09-20T05:52:44.978Z"
        ...
        if "dataToreturn" in info :
        
            # classification==1 --> human 
            # classification==2  --> ai 
            
            result =1 if  float( info ["dataToreturn"]["aiIndex"] )>0.5 else 0
            probability = info ["dataToreturn"]["aiIndex"]
        else:
            result = -1 
            probability = None 
